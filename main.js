...
const obj = [{
  name: 'Fashion Week',
  description: 'This is a template for a Fashion and Clothing events page. The main objective is to showcase my skills in HTML/CSS, Bootstrap and JavaScript.',
  image: ['images/SVG/Snapshoot Portfolio.svg'],
  technologies: ['HTML', 'CSS', 'Bootstrap 5', 'JavaScript'],
  live: 'https://hunterx-7.github.io/Fashion-Week/',
  source: 'https://github.com/HunterX-7/Fashion-Week',
  projects: ['project1', 'project2', 'project3', 'project4', 'project5', 'project6'],
},
{
  name: 'Awesome Books',
  description: 'This is a template for a booklist app to showcase my understanding of the different ways to create objects, create and access properties, and methods of JavaScript objects.',
  image: ['images/SVG/Snapshoot Portfolio (1).svg'],
  technologies: ['HTML', 'CSS', 'Bootstrap 5', 'JavaScript'],
  live: 'https://hunterx-7.github.io/Awesome-Booklist/',
  source: 'https://github.com/HunterX-7/Awesome-Booklist',
  projects: ['project1', 'project2', 'project3', 'project4', 'project5', 'project6'],
},
{
  name: 'Todays To Do List',
  description: 'This is a simple web page project using webpack and served by a webpack dev server. The main feature is a list of To Do task.',
  image: ['images/SVG/Snapshoot Portfolio (2).svg'],
  technologies: ['HTML', 'CSS', 'Bootstrap 5', 'JavaScript'],
  live: 'https://hunterx-7.github.io/To-Do-List/',
  source: 'https://github.com/HunterX-7/To-Do-List',
  projects: ['project1', 'project2', 'project3', 'project4', 'project5', 'project6'],
},
{
  name: 'Project Athena',
